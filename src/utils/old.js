...
const options = {
  key: fs.readFileSync("/etc/letsencrypt/live/blessedbypba.org/privkey.pem"),
  cert: fs.readFileSync("/etc/letsencrypt/live/blessedbypba.org/fullchain.pem"),
};

// MySQL connection pool
const pool = mysql.createPool({
  host: "u500774472_blessedbypba",
  user: "u500774472_admin",
  password: "Admin_password2024",
  database: "82.197.82.66",
...
https.createServer(options, app).listen(PORT, () => {
  console.log(`Server running on https://blessedbypba.org:${PORT}`);
});
