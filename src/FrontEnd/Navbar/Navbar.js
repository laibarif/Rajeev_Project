    ...
    return (
        <nav className="navbar">
            ...
            <ul className="navbar-nav">
                ...
                <li className="nav-item">
                    <Link className="nav-link" to="/market-my-property">Market My Property</Link>
                </li>
                <li className="nav-item">
                    <Link className="nav-link" to="/why-sell-with-us">Why Sell With Us</Link>
                </li>
                <li className="nav-item">
                    <Link className="nav-link" to="/social-media-reach">Our Social Media Reach</Link>
                </li>
                ...
                <li className="nav-item">
                    <Link className="nav-link" to="/chatwithus">Connect With Us</Link>
                </li>
                <li className="nav-item">
            ...
            {/* Chakra UI Drawer for "Other Services" (Mobile) */}
