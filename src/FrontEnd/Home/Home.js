        ...
        <div className="action-btn-container" >
          ...
          {showIcons && (
            <div className="home-social-icons-container">
              ...
              <FaFacebook className="home-social-icon" onClick={shareOnFacebook} />
              <FaEnvelope className="home-social-icon" onClick={shareOnEmail} />
              <FaInstagram className="home-social-icon" onClick={shareOnInstagram} />
              <FaLinkedin className="home-social-icon" onClick={shareOnLinkedIn} />
              <FaTwitter className="home-social-icon" onClick={shareOnTwitter} />
              <FaTimes className="home-social-icon close-icon" onClick={toggleIcons} />
            </div>
          )}
        </div>
        <div className="action-btn-container" >
