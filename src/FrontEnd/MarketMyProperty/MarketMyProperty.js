    ...
    const handleChange = (e) => {
        ...
        if (name === 'name') {
            ...
            if (value !== cleanedValue) {
                setNameError('Only alphabetic characters are allowed in the name field');
        ...
        // Handle mobile field to allow only numbers
            ...
            setMobileError(value !== cleanedValue ? 'Only numeric characters are allowed' : '');
            setFormData({ ...formData, [name]: cleanedValue });
            ...
            <div className="market-property-form">
                    ...
                    <div className="form-fields">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-buttons">
                                <button className="cancel-btn" onClick={() => setFormData({ name: '', email: '', mobile: '', address: '' })}>Cancel</button>
                ...
                <div className="additional-buttons">
                    ...
                    <div className="action-btn-container" >
                        <button className="action-btn refer-btn" onClick={toggleIcons}>Refer Us</button>
