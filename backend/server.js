...
app.post('/submit-form', (req, res) => {
  ...
  const query = 'INSERT INTO contact_form (name, email, mobile, comment) VALUES (?, ?, ?, ?)';
...
app.post('/submit-property', (req, res) => {
  ...
  const query = 'INSERT INTO market_property (name, email, mobile,comment, address) VALUES (?, ?, ?, ?)';
...
app.post('/other-services', (req, res) => {
  ...
  const query = 'INSERT INTO service_requests (name, email, mobile, service_type) VALUES (?, ?, ?, ?)';
  ...
  pool.getConnection((err, connection) => {
    ...
    connection.query(query, [name, email, mobile, serviceType], (err, result) => {
      connection.release();
...
app.post('/api/add-property', upload.single('image'), (req, res) => {
  ...
  const query = 'INSERT INTO properties (name, location, price, description, image, sold_out) VALUES (?, ?, ?, ?, ?, ?)';
  ...
  pool.getConnection((err, connection) => {
    ...
    connection.query(query, [name, location, price, description, image, soldOutValue], (err, result) => {
      connection.release();
...
app.post('/api/enquiries', (req, res) => {
  ...
  const query = 'INSERT INTO enquiries (propertyId, propertyName, name, email, mobile) VALUES (?, ?, ?, ?, ?)';
  ...
  pool.getConnection((err, connection) => {
    ...
    connection.query(query, [propertyId, propertyName, name, email, mobile], (err, result) => {
      connection.release();
      ...
      res.status(200).json({ message: 'Enquiry saved successfully', enquiryId: result.insertId });
    });
  });
});
